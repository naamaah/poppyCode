    ...
    def run(self):
        ...
        with mp_pose.Pose(min_detection_confidence=0.7, min_tracking_confidence=0.5) as pose:
            ...
            #while (not s.finish_workout): #for the all components
                ...
                s.prev_frame_from_joint_list=frameNumber
                frameNumber = frameNumber + 1
                #s.current_frame_from_joint_list = frameNumber
                ...
                for key,value in joint_humam_dict.items():
                ...
                s.current_joint_list = landmarkes_data.iloc[-4:]
                s.current_frame_from_joint_list=frameNumber
                ...
                #print(s.current_frame_from_joint_list)
                #print(s.prev_frame_from_joint_list)
                ...
                if key == ord('q'):
                    ...
                    landmarkes_data.to_excel(excel_writer=R'C:\Users\TEMP.NAAMA\Desktop\ImageFromCode\EXCEL/' + worksheet_name_exist,
                                             sheet_name="Try")
                    ...
                    landmarkes_data_all.to_excel(
                        excel_writer=R'C:\Users\TEMP.NAAMA\Desktop\ImageFromCode\EXCEL/' + worksheet_name_all,
                        sheet_name="Try")
                    cap.release()
                    break
